<template>
  <div class="w-full bg-[#051837] px-4 py-6 lg:pt-8 lg:pb-10">
    <div class="max-w-[1440px] mx-auto">
      <!-- Header -->
      <div
        class="flex items-center justify-between mb-4 text-white text-sm uppercase"
      >
        <h2
      ...
      <div
        ref="scrollContainer"
        :class="[
          'flex gap-4 no-scrollbar cursor-grab active:cursor-grabbing',
          isOverflowing ? 'overflow-x-auto' : 'justify-center',
        ]"
      ...
      >
        <div
          ...
          :key="provider.name"
          class="min-w-[140px] md:min-w-[160px] flex flex-col items-center justify-center flex-shrink-0 bg-[#12294A] rounded-lg text-center text-white"
        >
          <div class="w-full h-[68px] flex items-center justify-center">
            <img
              :src="provider.logo"
              :alt="provider.name"
              class="w-[93px] h-[30px] object-contain select-none"
            />
          </div>
          <div class="bg-[#F5F9FF0D] h-[54px] w-full flex flex-col space-y-1 items-center justify-center">
            <p class="text-white underline text-sm leading-[18px] font-normal truncate select-none">
              {{ provider.name }}
            </p>
            <p class="text-xs leading-3 text-[#90A2BD] underline select-none">
...
const providers: Provider[] = [
  { name: "Evolution", logo: "/logos/evolution.png", games: 312 },
  { name: "Spribe", logo: "/logos/spribe.png", games: 12 },
  { name: "VeltPlay", logo: "/logos/veltplay.png", games: 9 },
  { name: "Turbo Games", logo: "/logos/turbo.png", games: 36 },
  { name: "SmartSoft", logo: "/logos/smartsoft.png", games: 37 },
  { name: "100HP Gaming", logo: "/logos/100hp.png", games: 7 },
  { name: "BGaming", logo: "/logos/bgaming.png", games: 166 },
  { name: "Wazdan", logo: "/logos/wazdan.png", games: 109 },
];
